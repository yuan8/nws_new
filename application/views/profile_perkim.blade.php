...
<script type="text/javascript">
  ...
  getDATA(['tb_provinsi|*|DB_kode_daerah', 'tb_urusan|*|DB_id_urusan', 'tb_sub_urusan|*|DB_id_sub_urusan', 'tb_program|*|DB_kode_program'], ['total_anggaran', 'total_anggaran_air_minum', 'jumlah_program',
    'jumlah_kegiatan'], []);
