...
function showpanelCatatan(suara=false){
	...
	jsPanel.create({
	    ...
	    contentSize: '700 250',
	    content:     '<form id="form_panel_catatan" action="<?php echo e(rt('catatan/store')); ?>" method="post"><div>'+"<button type='button' class='btn btn-primary' type='button' onclick='catatanPlus(this)'>+</button></div>"+'<div class="con">'+localStorage.getItem("nuwas_panel_catatan")+'</div><button type="submit" class="btn btn-primary mt-4 col-md-6">Kirim</button></form>',
	    callback: function () {
...
</style><?php /**PATH C:\xampp\htdocs\nws\application\views/component/panel.blade.php ENDPATH**/ ?>