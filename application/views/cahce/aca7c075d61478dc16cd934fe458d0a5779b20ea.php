...
<script type="text/javascript">
  ...
  $.post('<?php echo e(rt("Program_kegiatan/program_kegiatan_get_data_chart/per_provinsi")); ?>',{id_dom:'chart-container-per-daerah','where':[],map:['per_provinsi','per_kota','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-daerah').html(res);
  });

   $.post('<?php echo e(rt("program_kegiatan/program_kegiatan_get_data_chart/per_urusan")); ?>',{id_dom:'chart-container-per-urusan','where':[],map:['per_urusan','per_sub_urusan','per_program']},function(res){
