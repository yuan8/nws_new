  ...
  <div class="row">
    <div class="col-md-4">
      <div class="form-group">
        ...
        <!-- <div class="custom-control custom-switch">
          <input type="checkbox" class="custom-control-input" checked name="data_show[]" value="persentase_anggaran" id="sd5">
          <label class="custom-control-label" for="sd5">Persentase Anggaran (Daerah)</label>
        </div> -->
...
<aside class="control-sidebar control-sidebar-dark" id="k" style="height:calc(100vh - 60px); overflow-y:scroll; position:fixed;">
  ...
  <form class="" action="" method="get" id="form_filter">
    <ul class="list-group" id="list_positif" style="min-height: 100px; background-color: #f1f1f1;">
      ...
      <li class="list-group-item tr op daerah text-dark">Provinsi
        <input type="hidden" name="map[]" value="tb_provinsi|*|DB_kode_daerah">
      </li>
        <li class="list-group-item tr op daerah text-dark">Kota Kabupaten
        <input type="hidden" name="map[]" value="tb_kabupaten|*|DB_kode_daerah_kabupaten">
      </li>
...
Highcharts.mapChart('map-container', {
  ...
  title: {
      text: 'Persentase Anggaran Tiap Provinsi Terhadap Kegaitan Pendukung Air Minum Perkotaan'
  },
...
<?php echo $__env->make('template.lay1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/NUWAS/nuwas/application/views/index.blade.php ENDPATH**/ ?>