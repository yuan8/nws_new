...
<div class="row no-guttres">
  <div class="background-landing">
    ...
    <div class='title'>
        ...
        <p>
          <img src="<?php echo e(rt('dist/images/logo.png')); ?>" alt="" style="max-width:10%;">
        </p>
...
<?php echo $__env->make('template.lay1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/NUWAS/nuwas/application/views/pages/landing.blade.php ENDPATH**/ ?>