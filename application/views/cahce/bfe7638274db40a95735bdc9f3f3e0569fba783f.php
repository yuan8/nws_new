...
<div class="col-md-12 " style="padding-top:40px; ">
  <h5 class="text-center text-white "><b>DATA ANGGARAN KEGIATAN TARGET NUWAS</b></h5>
</div>
...
<script type="text/javascript">
  ...
  $.post('<?php echo e(rt("keuangan/program_kegiatan_get_data_chart/per_provinsi")); ?>',{id_dom:'chart-container-per-daerah','where':[['a.kode_daerah','in',"('1207','1373','1472','1403','1709','3202','3311','3572','3524','3502','6301','7172')",'array']],map:['per_provinsi','per_kota','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-daerah').html(res);
  });

   $.post('<?php echo e(rt("keuangan/program_kegiatan_get_data_chart/per_urusan")); ?>',{id_dom:'chart-container-per-urusan','where':[['a.kode_daerah','in',"('1207','1373','1472','1403','1709','3202','3311','3572','3524','3502','6301','7172')",'array']],map:['per_urusan','per_sub_urusan','per_program']},function(res){
...
<?php echo $__env->make('template.lay1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/NUWAS/nuwas/application/views/pages/keuangan_nuwas.blade.php ENDPATH**/ ?>