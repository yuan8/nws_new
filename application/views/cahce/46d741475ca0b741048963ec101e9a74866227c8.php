  ...
  <div class="col-12 col-sm-12 col-lg-12">
      ...
      <div class="col-md-12">
        <ul class="nav nav-tabs btn-group" id="custom-tabs-two-tab" role="tablist">
          ...
          <li class="nav-item">
           <a class="nav-link bg-default " id="menu_menurut_urusan_perkasa" data-toggle="pill" href="#menu_menurut_perkasa_content" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">PERKADA</a>
         </li>
         <li class="nav-item">
          <a class="nav-link bg-default " id="menu_menurut_urusan_rspam" data-toggle="pill" href="#menu_RSPAM" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">RSPAM</a>
        </li>
        ...
        <div class="col-md-12 mb-4">
          <div class="tab-content" id="custom-tabs-two-tabContent">
            ...
            <div class="tab-pane fade" id="menu_menurut_perkasa_content" role="tabpanel" aria-labelledby="menu_menurut_urusan">
              <div class="col-md-12" id="chart-container-perkada">
             </div>
           </div>
...
<script type="text/javascript">
  ...
  // });
   $.post('<?php echo e(rt("Test")); ?>',{id_dom:'chart-container-per-urusan','where':[],map:['per_pn','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-urusan_pn').html(res);
  });
    ...
    $.post('<?php echo e(rt("Test/spm")); ?>',{id_dom:'chart-container-per-urusan','where':[],map:['per_spm','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-urusan_spm').html(res);
  ...
  $.post('<?php echo e(rt("Test/sdgs")); ?>',{id_dom:'chart-container-per-urusan','where':[],map:['per_sdgs','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-urusan_sdgs').html(res);
...
<?php echo $__env->make('template.lay1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/NUWAS/nuwas/application/views/pages/kebijakan.blade.php ENDPATH**/ ?>