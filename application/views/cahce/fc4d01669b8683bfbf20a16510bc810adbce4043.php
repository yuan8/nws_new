...
<div class="col-md-12">
	<div class="card mb-4">
		<div class="card-body">
			<form action="<?php echo e(rt('catatan/store')); ?>" method="post" id="form_simpan_catatan">
				<div class="row">
				<div class="col-md-12 mb-4">
					<input required="" type="text" class="form-control" placeholder="Judul" name="judul">
				</div>
				<div class="col-md-6">
					 <div id="catatan_rich_text" ><?php echo old('catatan'); ?></div>
						 <textarea required="" style="display: none" name="catatan" id="catatan_rich_text_textarea"><?php echo !old('catatan'); ?></textarea>
						 <hr>

					</div>
					<div class="col-md-6">
						 <div id="rekomendasi_rich_text" ><?php echo old('rekomendasi'); ?></div>
							 <textarea required="" style="display: none" name="rekomendasi" id="rekomendasi_rich_text_textarea"><?php echo !old('rekomendasi'); ?></textarea>
							 <hr>
