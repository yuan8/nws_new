...
<div class="row justify-content-md-center align-items-center">
	...
	<div class="col-md-4 text-center text-uppercase">
        ...
        <p>
          <img src="<?php echo e(rt('/dist/images/logo.png')); ?>" alt="" style="max-width:50%;">
        </p>
	...
	<div class="col-md-4 col-md-offset-2">
	    ...
	    <div class="card-body login-card-body">
	      <p class="login-box-msg text-dark text-uppercase"><b>Masuk Aplikasi NUWSP</b> </p>

	      <form action="<?php echo e(rt('login/aksi_login')); ?>" method="post">
	        <div class="input-group mb-3">
	          <input type="text" class="form-control" placeholder="Email / Username" required="" name="email" value="<?php echo e(old('email')); ?>">
