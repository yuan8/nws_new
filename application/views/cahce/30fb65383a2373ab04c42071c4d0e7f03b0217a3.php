      ...
      <table class="table table-bordered table-feedback">
      			...
      			<tbody>
      				<tr>
      					...
      					<th colspan="4"> KABUPATEN SUKOHARJO, JAWA TENGAH</th>

      				</tr>
      				<tr>
      					<th colspan="2">B. Nama Kota / Kabupaten</th>
      					<td colspan="4">KABUPATEN SUKOHARJO, JAWA TENGAH</td>
      				</tr>
      				<tr>
      					<th colspan="2">C. Tanggal masukan</th>
      					<td colspan="4">06/12/2018</td>
      				</tr>
      				<tr>
      				...
      				<tr>
      					...
      					<th colspan="4">Gunakan data dari PemDa mengenai RISPAM dan APBD</th>
      							...
      							<td>5.1.Nama Pemerintah Daerah</td>
                                                              <td colspan="5">KABUPATEN SUKOHARJO, JAWA TENGAH</td>                                                        </tr>
      												<tr>
...
<?php echo $__env->make('template.lay1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/NUWAS/nuwas/application/views/pages/pdam_detail.blade.php ENDPATH**/ ?>