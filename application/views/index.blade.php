...
@section('content')
<script src="{{rt('dist/js/sort.js')}}" charset="utf-8"></script>
<script src="{{rt('dist/js/datatable.js')}}" charset="utf-8"></script>
<link rel="stylesheet" href="{{rt('dist/css/datatable.css')}}">
...
getdtFrom() ;
  ...
  function detailKegiatan(i){
    ...
    window.open('{{rt('get_detail_kegiatan')}}?'+where_final,'_blank');
