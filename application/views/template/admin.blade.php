...
<script type="text/javascript" src="{{rt('dist/vendor/jspanel/jspanel.min.js')}}"></script>

<link href="{{rt('dist/vendor/jspanel/jspanel.css')}}" rel="stylesheet">
<!-- jsPanel JavaScript -->

<!-- optional jsPanel extensions -->
<script src="{{rt('dist/vendor/jspanel/extensions/modal/jspanel.modal.js')}}"></script>
<script src="{{rt('dist/vendor/jspanel/extensions/tooltip/jspanel.tooltip.js')}}"></script>
<script src="{{rt('dist/vendor/jspanel/extensions/hint/jspanel.hint.js')}}"></script>
<script src="{{rt('dist/vendor/jspanel/extensions/layout/jspanel.layout.js')}}"></script>
<script src="{{rt('dist/vendor/jspanel/extensions/contextmenu/jspanel.contextmenu.js')}}"></script>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{rt('/dashboard')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
<!--     <form class="form-inline ml-3">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="  nav-item dropdown">
          <a href="javascript:void(0)"  data-toggle="dropdown" class="nav-link  dropdown-toggle"><i class="fas fa-user-circle"></i> {{auth('name')}}</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{rt('admin')}}" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{rt('dash/file/rpjmd')}}" class="nav-link">
          ...
          @endif
          <li class="nav-item ">
            <a href="{{rt('admin/profile-daerah')}}" class="nav-link">
