...
<div class="row" class="animated fadeInUp">
    <div class="col-md-4 ">
        <div class="card bg-special-2 same_height text-dark">
            <div class="card-body text-center" id="{{$id_dom}}pie">
                <h6 class="text-center text-dark"><b>Jumlah Anggaran Total</b></h6>
                <h4 class=""><b>TAHUN {{$tahun}}</b> </h4>
               
                <hr style=" border-bottom:2px solid #222;">

                <h5 class="text-center text-white">Rp.{{number_format($rekap_program_kegiatan['jumlah_anggaran_kegiatan'],0,',','.')}}</h5>
                <hr style=" border-bottom:2px solid #222;">
                    ...
                    <tbody>
                        <?php foreach ($data as $key => $value): ?>
                            <tr>
                                ...
                                <td>{{$value['nama']}}</td>
                                <td>{{number_format($value['anggaran_kegiatan'],0,',',' ')}}</td>
