...
<script type="text/javascript">
  ...
  // });
   $.post('{{rt("Test")}}',{id_dom:'chart-container-per-urusan','where':[],map:['per_pn','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-urusan_pn').html(res);
  });
    ...
    $.post('{{rt("Test/spm")}}',{id_dom:'chart-container-per-urusan','where':[],map:['per_spm','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-urusan_spm').html(res);
  ...
  $.post('{{rt("Test/sdgs")}}',{id_dom:'chart-container-per-urusan','where':[],map:['per_sdgs','per_urusan','per_sub_urusan','per_program']},function(res){
    $('#chart-container-per-urusan_sdgs').html(res);
