            ...
            <table class="table table-bordered table-feedback">
                ...
                <tbody>
                    <tr>
                        ...
                        <th colspan="4">{{$data['kode_pdam']}}</th>

                    </tr>
                    <tr>
                        <th colspan="2">B. Nama Kota / Kabupaten</th>
                        <td colspan="4">{{$data['kabkota']}}</td>
                    </tr>
                    <tr>
                        <th colspan="2">C. Tanggal masukan</th>
                        <td colspan="4">{{$data['tanggal']}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            {{$data['target_cakupan_jaringan_pipa']}} &nbsp;
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                             {{$data['target_cakupan_jaringan_nonpipa']}} &nbsp;
